  ...
  <div class="cont_ri" id="ri_cont">
    <div class="sale_box">
      <div class="cont_ri_til clearfix">
        <div class="left_btn">
          <ul id="tabs_ul">
            <li class="cont">畅捷通报表</li>
          </ul>
        </div>
      </div>
      <span id="box_tab">
		<div style="margin-top:20px; width: 33%;height:20px;float:left;text-align: center">
			余额：<strong>0.00</strong>
		</div>
		<div style="margin-top:20px; width: 33%;height:20px;float:left;text-align: center">
			保证金：<strong>0.00</strong>
		</div>
		  <div style="margin-top:20px; width: 33%;height:20px;float:left;text-align: center">
			  银行行号、行名下载：<strong><a href="${ctx}/chanpay/g40001/download">点击下载</a></strong>
		  </div>
