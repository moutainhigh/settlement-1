...
<c:set var="search_path"
       value="${ctx}/unspay/payUpload?filename=${filename}&uploadStartDate=${uploadStartDate}&uploadEndDate=${uploadEndDate}"/>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            function loadUploadDetailData(filename) {
                ...
                $.get("${ctx}/unspay/uploadPayDetail", {'filename': filename}, function (list) {
            ...
            function verify(verifyStatus) {
                ...
                $.post("${ctx}/unspay/varifyPay/" + verifyStatus, {
                    'orderIds': orders,
                    'date': new Date()
                }, function (status) {
                    if (status != '1') {
...
<div class="tab_cont clearfix">
    <div class="cont_ri" id="ri_cont">
      ...
      <div class="condition_a">
          <ul class="clearfix">
              <form id="page_form" action="${ctx}/unspay/payUpload" method="GET">
                  <li>
                      <label>文件名称</label>
              ...
              <li style="width:200px;float: right;">
                  ...
                  <form id="upload_form" method="post" action="${ctx}/unspay/payUpload"
