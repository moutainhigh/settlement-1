...
public class GhbankOGW00061 {
    ...
    public void setOldReqNumber(String oldReqNumber) {
        this.oldReqNumber = oldReqNumber == null ? null : oldReqNumber.trim();
    }
    ...
    public void setOldReqName(String oldReqName) {
        this.oldReqName = oldReqName == null ? null : oldReqName.trim();
    }
