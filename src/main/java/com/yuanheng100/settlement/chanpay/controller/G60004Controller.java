...
import com.yuanheng100.settlement.chanpay.model.G60004Bean;
...
@Controller
@RequestMapping("/G60004")
public class G60004Controller {
public static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(G60004Controller.class);
	
	@RequestMapping(value = "/sendMessage")
	@ResponseBody
	public G60004Bean sendMessage(G60004Bean data) {
	...
	/** 组织Cj报文，并发送 */
	private void buildCjmsgAndSend(G60004Bean data) {
		try {
	...
	private void parseCjMsgToDto(String cjRespmsg, G60004Bean data) throws Exception {
